...
data class OWResult(
    @SerializedName("cod") var status: Int,
    @SerializedName("id") var id: Int,
    @SerializedName("name") var name: String,
    @SerializedName("timezone") var timezone: Int,
    @SerializedName("base") var base: String,
    @SerializedName("visibility") var visibility: Float,
    @SerializedName("dt") var datetime: Int,

    @SerializedName("coord") var coord: OWCoord,
    @SerializedName("weather") var weather: List<OWWeather>,
    @SerializedName("main") var main: OWMain,
